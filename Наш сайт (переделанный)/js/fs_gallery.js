...
//misoa worked ....append ('<div class="my_fullscreen-gallery" style="position:relative;">'+
      jQuery('body').append('<div class="fs_gallery_wrapper"><ul class="' + fs_options.fit + ' fs_gallery_container ' + fs_options.fx + '"/></div>');
//jQuery('.my_fullscreen-gallery').height(window_h - header.height()-1);    //misoa height of block - first initiaizing
jQuery('.fs_gallery_wrapper').height(window_h - header.height()-1);    //misoa height of block - first initiaizing
